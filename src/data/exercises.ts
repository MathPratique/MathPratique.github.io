...
const manualExercises: Exercise[] = [
  ...
  // ═════════════════════════════════════════════════════════════════
  {
    ...
    lessonId: "PSD4",
    number: 66,
    title: "QCM — Signe de r négatif",
    difficulty: "Facile",
    type: "mcq",
    prompt: "Un coefficient de corrélation r négatif signifie :",
    options: [
      { id: "a", content: "qu'une erreur a été commise (r doit être positif)", correct: false },
      { id: "b", content: "que le lien est nécessairement faible", correct: false },
      { id: "c", content: "que quand x augmente, y tend à diminuer", correct: true },
      { id: "d", content: "que r est en dehors des bornes normales", correct: false },
    ],
    explanation: "Le signe de r indique le sens du lien : négatif → x et y varient en sens opposés. Le signe ne dit rien sur la force (qui est |r|).",
    steps: [],
    answer: "Quand x augmente, y tend à diminuer.",
  },
  {
    id: "cor-qcm-02",
    topicId: "probability",
    lessonId: "PSD4",
    number: 67,
    title: "QCM — Bornes de r",
    difficulty: "Facile",
    type: "mcq",
    prompt: "Le coefficient de corrélation r peut prendre les valeurs :",
    options: [
      { id: "a", content: "de 0 à 1", correct: false },
      { id: "b", content: "de −1 à 1", correct: true },
      { id: "c", content: "de −100 % à 100 %", correct: false },
      { id: "d", content: "de 0 à 100", correct: false },
    ],
    explanation: "Par définition, −1 ≤ r ≤ 1. r = 0 signifie pas de lien linéaire ; r = ±1 signifie alignement parfait.",
    steps: [],
    answer: "−1 ≤ r ≤ 1.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 68,
    title: "QCM — Interpréter la pente",
    difficulty: "Facile",
    type: "mcq",
    prompt: "Pour la droite ŷ = 10 + 2x, la pente 2 signifie :",
    options: [
      { id: "a", content: "y vaut 2 quand x = 0", correct: false },
      { id: "b", content: "x vaut 2 en moyenne", correct: false },
      { id: "c", content: "une augmentation d'une unité de x augmente en moyenne y de 2", correct: true },
      { id: "d", content: "2 % de la variation de y est expliquée", correct: false },
    ],
    explanation: "La pente b représente la variation moyenne de y pour +1 unité de x. L'ordonnée à l'origine (10) est y quand x = 0.",
    steps: [],
    answer: "Une augmentation d'une unité de x augmente en moyenne y de 2.",
  },
  {
    id: "cor-qcm-04",
    topicId: "probability",
    lessonId: "PSD4",
    number: 69,
    title: "QCM — Calcul de r²",
    difficulty: "Facile",
    type: "mcq",
    prompt: "Si r = 0,6, alors r² vaut :",
    options: [
      { id: "a", content: "1,2", correct: false },
      { id: "b", content: "0,12", correct: false },
      { id: "c", content: "0,36", correct: true },
      { id: "d", content: "3,6", correct: false },
    ],
    explanation: "r² = (0,6)² = 0,36 = 36 % : proportion de la variation de y expliquée par la régression.",
    steps: [],
    answer: "r² = 0,36.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 70,
    title: "QCM — Formule du χ²",
    difficulty: "Facile",
    type: "mcq",
    prompt: "La formule de la statistique du khi-carré est :",
    options: [
      { id: "a", content: "Σ (O − E) / E", correct: false },
      { id: "b", content: "Σ (O − E)² / E", correct: true },
      { id: "c", content: "Σ (O² − E²)", correct: false },
      { id: "d", content: "√ Σ (O − E)²", correct: false },
    ],
    explanation: "χ² = Σ (O − E)²/E : somme sur toutes les cases des écarts au carré divisés par l'attendu.",
    steps: [],
    answer: "Σ (O − E)² / E.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 71,
    title: "QCM — Condition d'application du χ²",
    difficulty: "Facile",
    type: "mcq",
    prompt: "La condition d'application classique du test du khi-carré exige :",
    options: [
      { id: "a", content: "n ≥ 30 pour toute l'étude", correct: false },
      { id: "b", content: "E ≥ 5 dans toutes les cases", correct: true },
      { id: "c", content: "O ≥ 5 dans toutes les cases", correct: false },
      { id: "d", content: "que les variables soient continues", correct: false },
    ],
    explanation: "Condition classique : chaque effectif ATTENDU (E) doit être ≥ 5. Sinon, regrouper des catégories ou utiliser Fisher.",
    steps: [],
    answer: "E ≥ 5 dans toutes les cases.",
  },
  {
    id: "cor-qcm-07",
    topicId: "probability",
    lessonId: "PSD4",
    number: 72,
    title: "QCM — Calculer r à partir de sommes",
    difficulty: "Moyen",
    type: "mcq",
    prompt: "Pour n = 5, Σx = 15, Σy = 25, Σxy = 90, Σx² = 55, Σy² = 165. Quelle est la valeur de r ?",
    options: [
      { id: "a", content: "0,25", correct: false },
      { id: "b", content: "0,50", correct: false },
      { id: "c", content: "0,75", correct: true },
      { id: "d", content: "1,00", correct: false },
    ],
    explanation: "Numérateur = 5·90 − 15·25 = 75. Dénominateur = √[(5·55 − 225)(5·165 − 625)] = √(50 · 200) = √10 000 = 100. r = 0,75.",
    steps: [],
    answer: "r = 0,75.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 73,
    title: "QCM — Pente à partir de r et écart-types",
    difficulty: "Moyen",
    type: "mcq",
    prompt: "Sachant r = 0,5, s_x = 2 et s_y = 6, la pente b de la droite de régression de y sur x vaut :",
    options: [
      { id: "a", content: "0,17", correct: false },
      { id: "b", content: "1,5", correct: true },
      { id: "c", content: "3", correct: false },
      { id: "d", content: "6", correct: false },
    ],
    explanation: "b = r · s_y/s_x = 0,5 · 6/2 = 0,5 · 3 = 1,5.",
    steps: [],
    answer: "b = 1,5.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 74,
    title: "QCM — Prédiction avec la droite",
    difficulty: "Moyen",
    type: "mcq",
    prompt: "Avec la droite ŷ = 5 + 3x, quelle est la prédiction pour x = 4 ?",
    options: [
      { id: "a", content: "12", correct: false },
      { id: "b", content: "15", correct: false },
      { id: "c", content: "17", correct: true },
      { id: "d", content: "20", correct: false },
    ],
    explanation: "ŷ = 5 + 3 · 4 = 5 + 12 = 17.",
    steps: [],
    answer: "ŷ = 17.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 75,
    title: "QCM — Effectif attendu (2×2)",
    difficulty: "Moyen",
    type: "mcq",
    prompt: "Dans un tableau 2×2, le total de la ligne 1 vaut 60, le total de la colonne 1 vaut 40, et le grand total vaut 100. Quel est l'effectif attendu E(1,1) ?",
    options: [
      { id: "a", content: "20", correct: false },
      { id: "b", content: "24", correct: true },
      { id: "c", content: "30", correct: false },
      { id: "d", content: "40", correct: false },
    ],
    explanation: "E(1,1) = (total ligne × total colonne)/total général = (60 · 40)/100 = 2400/100 = 24.",
    steps: [],
    answer: "E(1,1) = 24.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 76,
    title: "QCM — Degrés de liberté 3×4",
    difficulty: "Moyen",
    type: "mcq",
    prompt: "Un test d'indépendance χ² porte sur un tableau 3 × 4. Combien de degrés de liberté ?",
    options: [
      { id: "a", content: "6", correct: true },
      { id: "b", content: "7", correct: false },
      { id: "c", content: "12", correct: false },
    ...
    explanation: "ddl = (r − 1)(c − 1) = (3 − 1)(4 − 1) = 2 · 3 = 6.",
    steps: [],
    answer: "ddl = 6.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 77,
    title: "QCM — χ² d'adéquation (dé)",
    difficulty: "Moyen",
    type: "mcq",
    prompt: "On lance un dé 60 fois. Observations pour les faces 1 à 6 : 12, 10, 11, 9, 10, 8. Sous H₀ (dé équilibré), la statistique χ²_obs vaut :",
    options: [
      { id: "a", content: "1,0", correct: true },
      { id: "b", content: "5,0", correct: false },
      { id: "c", content: "6,0", correct: false },
      { id: "d", content: "10,0", correct: false },
    ],
    explanation: "E = 10 par face. Contributions : 0,4 + 0 + 0,1 + 0,1 + 0 + 0,4 = 1,0.",
    steps: [],
    answer: "χ²_obs = 1,0.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 78,
    title: "QCM — Corrélation trompeuse",
    difficulty: "Difficile",
    type: "mcq",
    prompt: "Dans 50 pays, on trouve r = 0,90 entre le nombre de télévisions par habitant et l'espérance de vie. La meilleure conclusion est :",
    options: [
      { id: "a", content: "Les télés améliorent la santé.", correct: false },
      { id: "b", content: "Il faudrait acheter plus de télés pour vivre plus longtemps.", correct: false },
      { id: "c", content: "Il existe probablement une variable de confusion (richesse, système de santé).", correct: true },
      { id: "d", content: "Il n'y a aucun lien entre les deux variables.", correct: false },
    ],
    explanation: "Corrélation ≠ causalité. Ici, la richesse du pays est une variable de confusion qui augmente à la fois le nombre de télés et l'espérance de vie via un meilleur système de santé.",
    steps: [],
    answer: "Il existe probablement une variable de confusion (richesse).",
  },
  {
    id: "cor-qcm-14",
    topicId: "probability",
    lessonId: "PSD4",
    number: 79,
    title: "QCM — Deux droites de régression",
    difficulty: "Difficile",
    type: "mcq",
    prompt: "Pour un jeu de données avec r = 0,80 et s_x = s_y, les droites de régression de y sur x et de x sur y sont :",
    options: [
      { id: "a", content: "toujours identiques quand s_x = s_y", correct: false },
      { id: "b", content: "toujours perpendiculaires", correct: false },
      { id: "c", content: "distinctes en général ; elles coïncideraient seulement si |r| = 1", correct: true },
      { id: "d", content: "toujours parallèles", correct: false },
    ],
    explanation: "b_{y|x} · b_{x|y} = r². Les deux droites coïncident si et seulement si r² = 1 (alignement parfait). Ici r = 0,80 → r² = 0,64 < 1, elles restent distinctes.",
    steps: [],
    answer: "Distinctes en général ; identiques seulement si |r| = 1.",
  },
  {
    id: "cor-qcm-15",
    topicId: "probability",
    lessonId: "PSD4",
    number: 80,
    title: "QCM — Effet de n sur χ²",
    difficulty: "Difficile",
    type: "mcq",
    prompt: "On multiplie tous les effectifs d'un tableau χ² par 4 (proportions inchangées). Que devient χ²_obs ?",
    options: [
      { id: "a", content: "Il reste inchangé.", correct: false },
      { id: "b", content: "Il est multiplié par 2.", correct: false },
      { id: "c", content: "Il est multiplié par 4.", correct: true },
      { id: "d", content: "Il est divisé par 4.", correct: false },
    ],
    explanation: "Les contributions (O − E)²/E scalent linéairement avec n (car O et E sont multipliés par 4, donc (O−E)² par 16 et E par 4). χ² est donc multiplié par 4. Conséquence : avec assez de données, presque toute différence devient significative.",
    steps: [],
    answer: "χ² est multiplié par 4.",
  },
  {
    id: "cor-qcm-16",
    topicId: "probability",
    lessonId: "PSD4",
    number: 81,
    title: "QCM — Interprétation d'un cas limite",
    difficulty: "Difficile",
    type: "mcq",
    prompt: "Un test χ² à 1 ddl donne χ²_obs = 3,90 avec χ²_crit(5 %) = 3,84. La meilleure interprétation est :",
    options: [
      { id: "a", content: "« C'est prouvé. »", correct: false },
      { id: "b", content: "On rejette H₀ formellement, mais l'évidence est faible et devrait être répliquée.", correct: true },
      { id: "c", content: "On ne rejette pas H₀ (3,90 ≈ 3,84).", correct: false },
      { id: "d", content: "Le test n'est pas valide, il faudrait plus de données.", correct: false },
    ],
    explanation: "3,90 > 3,84 → rejet formel, mais on est à peine sous p = 0,05. Un test ne « prouve » jamais ; ici, l'évidence est fragile et mérite d'être reproduite.",
    steps: [],
    answer: "Rejet formel de H₀, mais évidence faible — à répliquer.",
  },
  // ═════════════════════════════════════════════════════════════════
  ...
  // ═════════════════════════════════════════════════════════════════
  {
    ...
    lessonId: "PSD4",
    number: 82,
    title: "V/F — Bornes de r",
    difficulty: "Facile",
    type: "tf",
    prompt: "Le coefficient de corrélation r est toujours compris entre −1 et 1 (inclusivement).",
    isTrue: true,
    explanation: "Vrai. Par construction, −1 ≤ r ≤ 1. Aucune donnée ne peut faire sortir r de cet intervalle.",
    steps: [],
    answer: "Vrai.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 83,
    title: "V/F — r² dans [0, 1]",
    difficulty: "Facile",
    type: "tf",
    prompt: "Le coefficient de détermination r² est toujours compris entre 0 et 1.",
    isTrue: true,
    explanation: "Vrai. Comme −1 ≤ r ≤ 1, le carré r² ∈ [0 ; 1]. Il représente la proportion de la variation de y expliquée par la régression.",
    steps: [],
    answer: "Vrai.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 84,
    title: "V/F — Corrélation implique causalité",
    difficulty: "Facile",
    type: "tf",
    prompt: "Une corrélation forte entre deux variables X et Y implique que X cause Y.",
    isTrue: false,
    explanation: "Faux. Corrélation ≠ causalité. Explications alternatives : causalité inverse (Y cause X), variable de confusion (Z cause X et Y), coïncidence. Seule une étude expérimentale contrôlée peut établir la causalité.",
    steps: [],
    answer: "Faux.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 85,
    title: "V/F — Signe pente = signe r",
    difficulty: "Facile",
    type: "tf",
    prompt: "La pente b de la droite de régression et le coefficient r ont toujours le même signe.",
    isTrue: true,
    explanation: "Vrai. b = r · s_y/s_x, et s_x, s_y sont positifs. Le signe de b est donc celui de r.",
    steps: [],
    answer: "Vrai.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 86,
    title: "V/F — ddl d'un test d'adéquation",
    difficulty: "Facile",
    type: "tf",
    prompt: "Pour un test d'adéquation à k catégories, le nombre de degrés de liberté vaut k.",
    isTrue: false,
    explanation: "Faux. Pour un test d'adéquation simple : ddl = k − 1 (une contrainte : la somme des effectifs vaut n).",
    steps: [],
    answer: "Faux.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 87,
    title: "V/F — Sens de r = 0",
    difficulty: "Facile",
    type: "tf",
    prompt: "Une valeur r = 0 signifie que les variables x et y sont statistiquement indépendantes.",
    isTrue: false,
    explanation: "Faux. r = 0 signifie seulement qu'il n'y a pas de lien LINÉAIRE. Un lien non linéaire (parabolique, périodique...) est parfaitement possible.",
    steps: [],
    answer: "Faux.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 88,
    title: "V/F — Invariance de r par translation",
    difficulty: "Moyen",
    type: "tf",
    prompt: "Ajouter une constante à toutes les valeurs de x (translation) ne change pas la valeur de r.",
    isTrue: true,
    explanation: "Vrai. r est invariant par translation ET par mise à l'échelle positive. Seule la multiplication par un scalaire négatif inverserait son signe.",
    steps: [],
    answer: "Vrai.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 89,
    title: "V/F — r² garantit modèle adéquat",
    difficulty: "Moyen",
    type: "tf",
    prompt: "Un r² proche de 1 garantit que le modèle linéaire est adéquat pour les données.",
    isTrue: false,
    explanation: "Faux. r² élevé peut coexister avec des résidus structurés (motif en U, aberrant) révélant une non-linéarité. Il faut toujours examiner le nuage et les résidus (leçon d'Anscombe).",
    steps: [],
    answer: "Faux.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 90,
    title: "V/F — r détecte tout type de lien",
    difficulty: "Moyen",
    type: "tf",
    prompt: "Le coefficient r détecte tout type de lien (linéaire ou non) entre deux variables.",
    isTrue: false,
    explanation: "Faux. r mesure UNIQUEMENT la force du lien linéaire. Un lien parfaitement déterministe non linéaire (ex. y = x²) peut donner r ≈ 0.",
    steps: [],
    answer: "Faux.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 91,
    title: "V/F — χ² toujours positif",
    difficulty: "Moyen",
    type: "tf",
    prompt: "La statistique χ² est toujours positive ou nulle.",
    isTrue: true,
    explanation: "Vrai. χ² est une somme de termes (O − E)²/E, tous ≥ 0 (carrés au numérateur, E positifs au dénominateur). Elle vaut 0 uniquement si O = E dans toutes les cases (ajustement parfait).",
    steps: [],
    answer: "Vrai.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 92,
    title: "V/F — Deux droites de régression identiques",
    difficulty: "Moyen",
    type: "tf",
    prompt: "Pour un jeu de données donné, la droite de régression de y sur x et celle de x sur y sont toujours identiques.",
    isTrue: false,
    explanation: "Faux. Elles diffèrent en général car le produit de leurs pentes vaut r². Elles ne coïncident que dans le cas parfait |r| = 1 (alignement exact).",
    steps: [],
    answer: "Faux.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 93,
    title: "V/F — Grand n et significativité",
    difficulty: "Moyen",
    type: "tf",
    prompt: "Avec un très grand n, même une différence minime peut devenir statistiquement significative dans un test du χ².",
    isTrue: true,
    explanation: "Vrai. χ² scale avec n (à proportions inchangées). Toujours combiner test statistique et taille d'effet pour juger de l'importance pratique.",
    steps: [],
    answer: "Vrai.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 94,
    title: "V/F — Interprétation de r²",
    difficulty: "Difficile",
    type: "tf",
    prompt: "r² représente la proportion de la variation de y expliquée par la régression linéaire sur x.",
    isTrue: true,
    explanation: "Vrai. C'est le coefficient de détermination : r² = variation expliquée / variation totale. Par ex., r² = 0,81 → 81 % de la variation de y est expliquée par x (linéairement).",
    steps: [],
    answer: "Vrai.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 95,
    title: "V/F — r détermine le nuage",
    difficulty: "Difficile",
    type: "tf",
    prompt: "Deux nuages de points ayant exactement le même r doivent avoir une structure semblable.",
    isTrue: false,
    explanation: "Faux — quartet d'Anscombe : quatre jeux avec mêmes x̄, ȳ, s_x, s_y et même r peuvent avoir des structures radicalement différentes (linéaire, courbe, aberrant, vertical). Toujours tracer le nuage.",
    steps: [],
    answer: "Faux.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 96,
    title: "V/F — Fiabilité du χ² avec petits E",
    difficulty: "Difficile",
    type: "tf",
    prompt: "Le test du khi-carré devient peu fiable dès que certains effectifs attendus (E) sont inférieurs à 5.",
    isTrue: true,
    explanation: "Vrai. La condition classique E ≥ 5 assure que l'approximation par la loi du χ² est valide. Sinon : regrouper, augmenter n, ou utiliser un test exact (Fisher).",
    steps: [],
    answer: "Vrai.",
  },
  {
    ...
    lessonId: "PSD4",
    number: 97,
    title: "V/F — Rejet dans χ² d'indépendance = causalité",
    difficulty: "Difficile",
    type: "tf",
    prompt: "Rejeter H₀ dans un test χ² d'indépendance prouve qu'une des deux variables cause l'autre.",
    isTrue: false,
    explanation: "Faux. Le rejet indique un lien statistique (non-indépendance), mais la causalité demanderait un plan expérimental (randomisation, contrôle des confondants). Corrélation/association ≠ causalité, ici aussi.",
    steps: [],
    answer: "Faux.",
  },
];
