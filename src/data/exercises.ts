...
const manualExercises: Exercise[] = [
  ...
  // ═════════════════════════════════════════════════════════════════
  {
    ...
    lessonId: "L29",
    number: 8,
    title: "QCM — Décomposition selon la base canonique",
    difficulty: "Intermédiaire",
    type: "mcq",
    prompt: [
      t("Le vecteur "), vec("v"),
      t(" = (3, −2) s'écrit dans la base canonique ("),
      vec("i"), t(", "), vec("j"), t(") de R² comme :"),
    ],
    options: [
      { id: "a", content: [t("3"), vec("i"), t(" − 2"), vec("j")], correct: true },
      { id: "b", content: [t("−2"), vec("i"), t(" + 3"), vec("j")], correct: false },
      { id: "c", content: [t("3"), vec("j"), t(" − 2"), vec("i")], correct: false },
      { id: "d", content: [vec("i"), t(" + "), vec("j")], correct: false },
    ],
    explanation: [
      t("Dans la base canonique, "), vec("i"), t(" = (1, 0) et "),
      vec("j"), t(" = (0, 1). Donc (3, −2) = 3·(1, 0) + (−2)·(0, 1) = 3·"),
      vec("i"), t(" − 2"), vec("j"),
      t(". Les composantes sont directement les coefficients dans la base canonique."),
    ],
    steps: [],
    answer: "3·i − 2·j",
  },
  {
    ...
    lessonId: "L29",
    number: 9,
    title: "QCM — Combinaison linéaire de deux vecteurs",
    difficulty: "Intermédiaire",
    type: "mcq",
    prompt: [
      t("Si "), vec("u"), t(" = (1, 2) et "), vec("v"),
      t(" = (3, −1), alors la combinaison 2"), vec("u"), t(" + "), vec("v"), t(" est :"),
    ],
    options: [
      { id: "a", content: "(5, 3)", correct: true },
      { id: "b", content: "(4, 4)", correct: false },
      { id: "c", content: "(5, 5)", correct: false },
      { id: "d", content: "(2, 4)", correct: false },
    ],
    explanation: [
      t("Calcul composante par composante : 2"), vec("u"),
      t(" = (2, 4), puis 2"), vec("u"), t(" + "), vec("v"),
      t(" = (2 + 3, 4 + (−1)) = (5, 3)."),
    ],
    steps: [],
    answer: "(5, 3)",
  },
  {
    ...
    lessonId: "L29",
    number: 10,
    title: "QCM — Test de colinéarité par déterminant",
    difficulty: "Avancé",
    type: "mcq",
    prompt: [
      t("Deux vecteurs "), vec("u"), t(" = (a, b) et "), vec("v"),
      t(" = (c, d) de R² sont colinéaires si et seulement si :"),
    ],
    options: [
      { id: "a", content: "a·d − b·c = 0", correct: true },
      { id: "b", content: "a + b = c + d", correct: false },
      { id: "c", content: "a·c + b·d = 0", correct: false },
      { id: "d", content: "a = c et b = d", correct: false },
    ],
    explanation: [
      t("Le test de colinéarité utilise le déterminant 2×2 : |a c ; b d| = a·d − b·c. Deux vecteurs sont colinéaires (linéairement dépendants) ssi ce déterminant est nul."),
    ],
    steps: [],
    answer: "a·d − b·c = 0",
  },
  {
    ...
    lessonId: "L29",
    number: 11,
    title: "Vrai ou Faux — Unicité de la décomposition",
    difficulty: "Intermédiaire",
    type: "tf",
    prompt: [
      t("Tout vecteur de R² s'écrit de manière unique comme combinaison linéaire de "),
      vec("i"), t(" = (1, 0) et "), vec("j"), t(" = (0, 1)."),
    ],
    isTrue: true,
    explanation: [
      t("Vrai. ("), vec("i"), t(", "), vec("j"),
      t(") forme une base de R² : tout vecteur (x, y) s'écrit de façon unique sous la forme x·"),
      vec("i"), t(" + y"), vec("j"),
      t(". L'unicité vient de l'indépendance linéaire de "),
      vec("i"), t(" et "), vec("j"), t("."),
    ],
    steps: [],
    answer: "Vrai",
  },
  {
    ...
    lessonId: "L29",
    number: 12,
    title: "Vrai ou Faux — Trois vecteurs dans R²",
    difficulty: "Avancé",
    type: "tf",
    prompt: [
      t("Trois vecteurs de R² sont toujours linéairement dépendants (l'un est combinaison linéaire des deux autres)."),
    ],
    isTrue: true,
    explanation: [
      t("Vrai. La dimension de R² est 2, donc tout ensemble de 3 vecteurs ou plus est nécessairement lié. Au moins l'un d'eux s'exprime comme combinaison linéaire des autres."),
    ],
    steps: [],
    answer: "Vrai",
  },
